...
@TarsStruct
public class TMsgNotifyEnterRoom {
	...
	public TMsgNotifyEnterRoom() {
	}

	public TMsgNotifyEnterRoom(TPlayerInfo tPlayerInfo) {
		this.tPlayerInfo = tPlayerInfo;
	}
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof TMsgNotifyEnterRoom)) {
			return false;
		}
		TMsgNotifyEnterRoom other = (TMsgNotifyEnterRoom) obj;
		return (
