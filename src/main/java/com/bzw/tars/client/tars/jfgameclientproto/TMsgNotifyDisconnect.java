...
@TarsStruct
public class TMsgNotifyDisconnect {
	...
	public TMsgNotifyDisconnect() {
	}

	public TMsgNotifyDisconnect(byte nChairNo) {
		this.nChairNo = nChairNo;
	}
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof TMsgNotifyDisconnect)) {
			return false;
		}
		TMsgNotifyDisconnect other = (TMsgNotifyDisconnect) obj;
		return (
